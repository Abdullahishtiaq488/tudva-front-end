...
const AddLecture = ({ onAdd }) => {
  ...
  return <>
    <Button variant='primary-soft' size='sm' onClick={toggle} className="mb-0" data-bs-toggle="modal" data-bs-target="#addLecture"><BsPlusCircle className="me-2" />Add Curriculum</Button>
    <Modal className="fade" show={isTrue} tabIndex={-1} aria-labelledby="addLectureLabel" aria-hidden="true">
      <ModalHeader className="bg-dark">
        <h5 className="modal-title text-white" id="addLectureLabel">Add Curriculum</h5>
      ...
      <ModalBody>
        <Form onSubmit={handleSubmit}>
          <Form.Group className="mb-3">
            <Form.Label>Curriculum Name <span className="text-danger">*</span></Form.Label>
            <Form.Control
              type="text"
      ...
      <ModalFooter>
        ...
        <button type="button" className="btn btn-success my-0" onClick={handleSubmit}>Save Curriculum</button>
      </ModalFooter>
    </Modal>
  </>;
};
