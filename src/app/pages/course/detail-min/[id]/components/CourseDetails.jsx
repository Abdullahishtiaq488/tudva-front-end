            ...
            <Row className="g-4">
              <Col xs={12}>
                ...
                <ul className="list-inline mb-0">
                  <li className="list-inline-item h6 me-3 mb-1 mb-sm-0"><FaStar className="text-warning me-2" />4.5/5.0</li>
                  <li className="list-inline-item h6 me-3 mb-1 mb-sm-0"><FaUserGraduate className="text-orange me-2" />12k Enrolled</li>
                  <li className="list-inline-item h6 me-3 mb-1 mb-sm-0"><FaSignal className="text-success me-2" />{course?.level || ""}</li>
                </ul>
              </Col>
              <Col xs={12}>
