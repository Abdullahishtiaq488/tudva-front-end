...
const Overview = ({course}) => {
  ...
  return <>
     ...
     <p>{course?.description?.replace(/<\/?p>/g, '')}</p>
...
const CourseTab = ({course}) => {
  return <TabContainer defaultActiveKey='overview'>
      <Nav className="nav-pills nav-pills-bg-soft px-3" id="course-pills-tab" role="tablist">
        ...
        <NavItem className="me-2 me-sm-4" role="presentation">
          <NavLink as='button' className="mb-0" type="button" eventKey="faqs">FAQs </NavLink>
        </NavItem>
        <NavItem className="me-2 me-sm-4" role="presentation">
          <NavLink as='button' className="mb-0" type="button" eventKey="comment">Comment</NavLink>
        </NavItem>
      </Nav>
